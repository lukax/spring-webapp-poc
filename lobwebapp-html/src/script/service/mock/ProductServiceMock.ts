...
export module service.mock {
    export class ProductServiceMock extends a.service.mock.base.EntityServiceMock<domain.Product> implements d.service.contract.ProductService {
        ...
        constructor(public $timeout: ng.ITimeoutService) {
            ...
            super.getRepository().push({ id: 3, name: "Memória", description: "Kingston KVR1333D3N9 8192 MB PC DDR3 1333 MHz", quantity: 34, costPrice: 76.34, price: 143.75, category: "Informática/Componentes", date: new Date(13,7,15), ncm: "8473.30.42"});
            super.getRepository().push({ id: 4, name: "Memória", description: "Markvision KMM2GBD3-1333 2048 MB PC DDR3 1333 MHz", quantity: 27, costPrice: 27.32, price: 25.10, category: "Informática/Componentes", date: new Date(11,4,9), ncm: "8473.30.42"});
            super.getRepository().push({ id: 5, name: "SSD", description: "Kingston SSDNow E100 SE100S37 100 GB Interno", quantity: 6, costPrice: 1035.00, price: 1388.82, category: "Informática/Armazenamento", date: new Date(12,5,10), ncm: "8473.30.99"});
