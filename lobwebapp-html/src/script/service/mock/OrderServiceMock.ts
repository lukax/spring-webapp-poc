    ...
    export class OrderServiceMock extends a.service.mock.base.EntityServiceMock<domain.Order> implements d.service.contract.OrderService {
        ...
        constructor(public $timeout: ng.ITimeoutService, public _: _<domain.Order>) {
            ...
            super.getRepository().push({
                id: 1, customer: { id: 1, firstName: "John", lastName: "Doe" }, date: new Date(13, 11, 1), status: { payment: 0, delivery: 0 }, payment: 3400,
                products: [
                ...
                id: 2, customer: { id: 2, firstName: "Jane", lastName: "Doe" }, date: new Date(13, 11, 2), status: { payment: 0, delivery: 0 }, payment: 3400,
                products: [
                    { id: 4, name: "Memória", description: "Markvision KMM2GBD3-1333 2048 MB PC DDR3 1333 MHz", quantity: 27, costPrice: 27.32, price: 25.10, category: "Informática/Componentes", date: new Date(11, 04, 09), ncm: "8473.30.42" },
                    { id: 5, name: "SSD", description: "Kingston SSDNow E100 SE100S37 100 GB Interno", quantity: 6, costPrice: 1035.00, price: 1388.82, category: "Informática/Armazenamento", date: new Date(12, 05, 10), ncm: "8473.30.99" }
                ],
            });
        }
