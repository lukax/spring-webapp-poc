        ...
        listCustomer() {
            ...
            this.CustomerService.list(
                (successData, successStatus) => {
                    ...
                    if (this.redirect) this.AlertService.add({ content: "Clique em um Cliente da lista para voltar para a página anterior", title: "Busca Rápida", type: enums.AlertType.INFO }); 
                },
                (errorData, errorStatus) => {
                    this.AlertService.add({ content: String(errorData), title: "Lista de Clientes não pôde ser carregada", type: enums.AlertType.DANGER });
                    this.NavigationService.progress.done();
                });
        }
