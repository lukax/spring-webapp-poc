...
import domain = require('./../../domain/base/AbstractEntity');
import service_contract = require('./../contract/base/EntityService');

export class AbstractEntityServiceMock<T extends domain.AbstractEntity> implements service_contract.EntityService<T> {
