...
public class AjaxAwareLoginUrlAuthenticationEntryPoint extends
	...
	/*
	 * private static final RequestMatcher requestMatcher = new
	 * ELRequestMatcher("hasHeader('X-Requested-With','XMLHttpRequest')");
	 */
	 ...
	 */
	/*
	 * private boolean isPreflight(HttpServletRequest request) { return
	 ...
	 */
	/*
	 * protected boolean isRestRequest(HttpServletRequest request) { return
