...
describe("service: AlertService", () => {
  beforeEach(() => {
    module(($provide:ng.auto.IProvideService) => {
      $provide.service("AlertService", entity.AlertServiceImpl);
    });
  });

  it("should retrieve an alert", inject((AlertService:entity.AlertService) => {
    expect(AlertService.list()).toBeDefined();
    expect(AlertService.list()).toEqual(jasmine.any(Array));
  }));

  it("should add an alert", inject((AlertService:entity.AlertService) => {
  ...
  it("should remove an alert", inject((AlertService:entity.AlertService) => {
  ...
  it("should remove old alerts", inject((AlertService:entity.AlertService, $interval:any) => {
  ...
  it("should not remove new alerts", inject((AlertService:entity.AlertService, $interval:any) => {
