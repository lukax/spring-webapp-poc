...
describe('service: EntityService', () => {
  ...
  var sampleNewEntity:core.AbstractEntity = { id: 0 };
  var sampleExistantEntity:core.AbstractEntity = { id: 213121 };
  var apiUrl:string = "/api/v1/entity";
  var EntityService:core.EntityService<core.AbstractEntity>;
  var $httpBackend:ng.IHttpBackendService;

  beforeEach(module("lwa.core", ($provide:ng.auto.IProvideService) => {
    $provide.value("apiUrl", apiUrl);
  }));
  beforeEach(inject((_EntityService_:core.EntityService<core.AbstractEntity>, _$httpBackend_:ng.IHttpBackendService) => {
