...
module core{
	export interface IEditEntityController<T extends core.AbstractEntity> extends IController {
		entity: T;
    isEntityNew: boolean;
	...
	export class AbstractEditEntityController<T extends core.AbstractEntity> implements IEditEntityController<T> {
