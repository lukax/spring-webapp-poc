...
module product.core {
  export class ProductServiceMock extends entity.EntityServiceMock<product.core.Product> implements ProductService {
    ...
    findByName(name:string,
               ...
               errorCallback:(data:entity.MessageResponse, status:number, headers:(headerName:string) => string, config:ng.IRequestConfig) => any, pageable:entity.Page) {
      this.$timeout(()=> {
...
angular.module("lwa.product.core").service("ProductService", product.core.ProductServiceMock);
