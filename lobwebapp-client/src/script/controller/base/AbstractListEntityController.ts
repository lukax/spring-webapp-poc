    ...
    listEntity(pageIndex: number) {
        ...
        this.EntityService.list(
            (successData, successStatus, headers) => {
                ...
                if (this._redirectUrl) this.AlertService.add({ title: "Busca Rápida", content: "Clique em um item da lista para voltar para a página anterior", type: enumUtil.AlertType.INFO });
            },
            (errorData) => {
